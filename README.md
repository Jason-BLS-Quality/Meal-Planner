...
- **Takeaway night near home** (researched for Greenbank QLD, ≤30 min drive): 17 chains (Nando's, Oporto, Red Rooster, KFC, McDonald's, Hungry Jack's, Grill'd, Betty's, Carl's Jr, GYG, Zambrero, Mad Mex, Subway, Domino's, Pizza Hut, Schnitz, Roll'd) with orders built from their official AU nutrition info, plus local independents (Thai, Indian, Chinese, fish & chips, kebab) with typical-dish estimates. Takeaway replaces that night's dinner (its groceries drop off), and each person is matched to the best order under their own calorie budget. Tap the 🥡 badge on the day to pick a place.
